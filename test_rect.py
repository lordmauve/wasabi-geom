import unittest
import pygame
from wasabigeom import ZRect as Rect
...
class RectTypeTest(unittest.TestCase):
    ...
    def test_collidedictall(self):
        ...
        self.assertEqual(collisions, [(2, r2)])
    ...
    def test_collidelist(self):
        ...
        r = Rect(1, 1, 10, 10)
        other = [Rect(50, 50, 1, 1), Rect(5, 5, 10, 10), Rect(15, 15, 1, 1)]

        self.assertEqual(r.collidelist(other), 1)
    ...
    def test_collidelistall(self):
        ...
        self.assertEqual(r.collidelistall(other), [0, 1, 3])
